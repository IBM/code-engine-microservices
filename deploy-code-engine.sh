...
ibmcloud ce app create -n hotel-v1 -i ${DOCKERHUB_NAME}/hotel-v1:latest --cl -p 9101 --min 1 --cpu 0.25 -m 0.5G -e HOST_IP=hotel-v1 -e LOG_LEVEL=info
ibmcloud ce app create -n carrental-v1 -i ${DOCKERHUB_NAME}/carrental-v1:latest --cl -p 9102 --min 1 --cpu 0.25 -m 0.5G -e HOST_IP=carrental-v1 -e LOG_LEVEL=info
